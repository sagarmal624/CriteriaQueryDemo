...
public class PersonService {
    ...
    public Person get(Long id) {
        return getSelectedColumnSinglePerson(id);
    }
    ...
    public void fetchMultipleColumn() {
        ...
        criteriaQuery.where(builder.equal(personRoot.get("email"), "salary"));
    ...
    public void fetchJoinBasedData() {
        ...
        criteriaQuery.where(builder.equal(personRoot.get("id"), 1));
